...
(function() {
  ...
  module.exports = Bitfinex = (function() {
    ...
    Bitfinex.prototype.symbols_details = function() {
      return this._makePublicRequest('symbols_details');
    };
    ...
    Bitfinex.prototype.ordersHistory = function() {
      return this._makePrivateRequest('orders/hist');
    };
    ...
    Bitfinex.prototype._makeRequest = function(path, params, method) {
      ...
      return new Promise(function(resolve, reject) {
        return request(requestObj, function(err, response, body) {
          var error, error1, result, statusCode;
